...
// Toggler ssearch in mobile devices
...
searchField.addEventListener("input", function () {
    ...
    if (!searchField.value) {
        ...
        searchField.classList.remove("seraching");
    } else {
        searchField.classList.add("seraching");
    }
...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
         ...
         <h2 class="title-2 card-title">Now</h2>
             ...
             <p class="heading">${parseInt(temp)}&deg;<sup>c</sup></p>
                ...
                <img src="./images/weathericons/${icon}.png" width="54" height="54"  alt=${description} class="weather-icon">
                </div>
        ...
        fetchData(url.airPollution(lat, lon), function (airPollution) {
            ...
            card.innerHTML = `
             <h2 class="title-2" id="highlights-lable">Todays Highlights</h2>
            ...
            <div class="highlight-list">
                ...
                <div class="card card-sm highlight-card two">
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <h3 class="title-3">Fells Like</h3>
        ...
        <ul class="slider-list" data-wind></ul>
            ...
            wind: { deg: windDirection, speed: windSpeed }
             ...
             <div class="card card-sm slider-card">
                    ...
                    <img src="./images/weathericons/${icon}.png"
             ...
             windLi.innerHTML = `
               <div class="card card-sm slider-card">
                    ...
                    <img src="./images/weathericons/direction.png"
